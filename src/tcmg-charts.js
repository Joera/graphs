...
var TCMGCharts = function TCMGCharts() {
    ...
    var mapInput = function(element) {
        ...
        d3.json("/assets/geojson/gem_grenzen_groningen.geojson", function(error, geojson) {
            ...
            var b = [
                    [20.4147116059472928,-20.1085755688135375],
                    [20.42150832154068851,-20.0957736701784277]
                ],
                s = .2 / Math.max((b[1][0] - b[0][0]) / dimensions.containerWidth, (b[1][1] - b[0][1]) / dimensions.height),
