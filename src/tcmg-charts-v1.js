...
var TcmgChartsV1 = function TCMGCharts() {
    ...
    var mapInput = function(element) {
        ...
        d3.json("/assets/geojson/townships-2015.json", function(error, geojson) {
            ...
            //     b = path.bounds(l),
            //     s = .2 / Math.max((b[1][0] - b[0][0]) / dimensions.svgWidth, (b[1][1] - b[0][1]) / dimensions.height),
            //     t = [(dimensions.svgWidth - s * (b[1][0] + b[0][0])), (dimensions.height - s * (b[1][1] + b[0][1])) / 2];
            ...
            var b = [
                ...
                s = .2 / Math.max((b[1][0] - b[0][0]) / dimensions.svgWidth, (b[1][1] - b[0][1]) / dimensions.height),
                t = [(dimensions.svgWidth - s * (b[1][0] + b[0][0])) / 2, (dimensions.height - s * (b[1][1] + b[0][1])) / 2];
