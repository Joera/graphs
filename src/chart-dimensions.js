class ChartDimensions {
    ...
    get(dimensions) {
        ...
        if (this.config.fixedWidth) {
            ...
            this.dimensions.svgWidth = d3.select(this.element).node().getBoundingClientRect().width - this.config.margin.left - this.config.margin.right;
        ...
        if(this.config.fixedHeight){
            ...
            this.dimensions.svgHeight = d3.select(this.element).node().getBoundingClientRect().height - this.config.margin.top - this.config.margin.bottom;
