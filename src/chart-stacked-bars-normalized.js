    ...
    let redraw = function redraw(dimensions,xScale,yScale,colours,smallMultiple) {
        ...
        svg.barLabels
            ...
            .attr('transform', function(d) {
              ...
              //  yOffset = dimensions.height / (2 * dataArray.length);
                ...
                return 'translate(' + (xScale.stackedNormalized(d[0]) - xOffset) + ',' + ((yScale.band(d.data[config.xParameter]) + ( yScale.band.bandwidth() / 2)) + 21 ) +')';
        ...
        svg.dateLabels
            ...
            .attr('transform', function (d,i) {
                ...
                if(i < 4) {
                    return 'translate(' + config.margin.left + ',' + (yScale.band(d[i].data['status']) + 2) + ')';
                }
            })
        ;
