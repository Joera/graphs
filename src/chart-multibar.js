let ChartMultiBars = function ChartMultiBars(config,svg) {
    ...
    let redraw = function redraw(dimensions,xScale,yScale) {
        ...
        svg.bar
            ...
            .transition()
            .duration(500)
            .attr("y", function(d) { return console.log(d); config.margin.top + yScale.linear(d['property']); })
            .attr("height", function(d) { return dimensions.height - yScale.linear(d['property']); })  // add
