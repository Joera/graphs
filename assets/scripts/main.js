...
var ChartStackedBars = function ChartStackedBars(config, svg, functions) {
    ...
    var redraw = function redraw(dimensions, scales) {
        ...
        .x0(function (d, i) {
            if (i < 1) {
                console.log(scales.xBand(d[0].data.status));return scales.xBand(d[0].data.status) + barWidth;
            } else {
        ...
        .x1(function (d, i) {
            if (i < 1) {
                console.log(scales.xBand(d[1].data.status));return scales.xBand(d[1].data.status) + barWidth;
            } else {
